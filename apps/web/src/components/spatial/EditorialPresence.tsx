...
export function EditorialPresence() {
  ...
  return <motion.figure
    ...
    initial={reduceMotion ? false : { opacity: 0, y: 18, scale: 1.015 }}
  ...
  >
    ...
    />
    <Image className="presence-armor" src="/images/agentreach-armor-overlay-v1.png" width={943} height={1676} sizes="(max-width: 900px) 72vw, 46vw" alt="" aria-hidden="true" />
