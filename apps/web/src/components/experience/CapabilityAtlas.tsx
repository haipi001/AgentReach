...
const SYSTEMS = [
  { index: "01", zone: "核心", plane: "自我", title: "身份被确认，而不是被暴露。", copy: "名称、运行状态与本地密钥让智能体只对你保持可辨识。光球只是状态表达，从不构成授权证明，也不会扩大访问范围。", signals: ["身份 / 本地", "核心 / 用户持有", "信号 / 可撤销", "状态 / 可检查", "名称 / HAIPI", "导出 / 锁定"] },
  ...
  { index: "03", zone: "能力", plane: "现实世界", title: "技能有意识地触达现实。", copy: "工具不是人格特征。每项能力都必须拥有狭窄授权、明确目标和可逆路径，才能离开自我空间执行。", signals: ["技能 / 06", "授权 / 限定", "触达 / 询问用户", "代码仓库 / 本地", "信箱 / 就绪", "撤销 / 就绪"] },
  ...
  return <section className="capability-atlas" aria-labelledby="atlas-title">
    ...
    <div ref={track} className="atlas-horizontal-track">
      <div className="atlas-sticky">
        ...
        <figure className="atlas-body" aria-hidden="true"><div className="atlas-photo-head"><i/><i/><i/></div><figcaption>自我 / 本地核心</figcaption></figure>
